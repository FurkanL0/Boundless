...
|------------------|----------------------------|----------------------------|
| **QuickPod GPU**          | [Link](https://console.quickpod.io?affiliate=f26ea1e1-e0d8-4bbc-9e7f-5b03dddde481) | İstediğimiz Sunucular / Kripto Ödeme |

- https://console.quickpod.io/settings?tab=billing 'den Kripto yada Kart ile bakiye ekleyebilirsiniz.
...
-  https://console.quickpod.io/settings?tab=keys - + New'den kayıt edin keyinizi.

![image](https://github.com/user-attachments/assets/0dce5e9d-8384-4666-bf54-e0508a3909a7)
